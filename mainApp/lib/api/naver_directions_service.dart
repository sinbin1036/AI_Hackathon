...
Future<List<List<double>>> fetchRouteCoordinates({
  ...
  final url =
      'https://maps.apigw.ntruss.com/map-direction/v1/foot?start=$startLng,$startLat&goal=$goalLng,$goalLat&option=walkComfort';
  ...
  if (response.statusCode != 200) {
    throw Exception('도보 Directions API 실패: ${response.body}');
  }

  final json = jsonDecode(response.body);
  final polylineList = json['route']['route'][0]['path'];
